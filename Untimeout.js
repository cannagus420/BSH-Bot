...
let wasMuted = false
if (mutedUsers.includes(userInfo.id)) {
  wasMuted = true
...
await lib.discord.users['@0.2.0'].dms.create({
  ...
  embeds: [
    {
      type: 'rich',
      title: wasMuted ? `You have been Unmuted in ${server.name}.` : `You have been released from Timeout in ${server.name}.`,
      description: ``,
  ...
  embeds: [
    {
      ...
      color: 0x5bed51, //green
      author: {
        name: wasMuted ? `${userInfo.username}#${userInfo.discriminator} was released from Permanent Timeout (Unmuted)` : `${userInfo.username}#${userInfo.discriminator} was released from Timeout`,
      ...
      embeds: [
        {
          ...
          author: {
            name: `${userInfo.username}#${userInfo.discriminator} has been released from Timeout`,
            icon_url: userInfo.avatar_url ? `${userInfo.avatar_url}` : ``,
          },
        },
      ],
